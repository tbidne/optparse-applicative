...
-- | Add group to 'OptProperties'. Only adds the group if it is currently
-- unset ('Nothing'); otherwise we do nothing. This means, in particular,
-- that nested groups:
--
-- @
...
--     created order, and duplicate groups are allowed.
--
--   - Nested groups use the innermost group:
--
--       @
--         parserOptionGroup "Group A" (parserOptionGroup "Group Z" parseA)
--       @
--
--       Will group @parseA@ under @"Group Z"@.
--
-- @since 0.19.0.0
